...
def get_tile(z, x, y, tableName, useCache):
    ...
    if not cacheVersionAvailable:
        ...
        conn = psycopg2.connect(
            "dbname=tiles user=tiles password=Uf8yQECNtJgPAicUwrZHsBoyB8SgDcEaiGfexsziUCsJzR3KyW73FpsAPQMYyfe host=tileserver-postgis"
        )
        cur = conn.cursor()
        ...
        print(
            "Generated tile at z={} x={} y={} for table {} in {}s and produced {}KB".format(
                z, x, y, tableName, duration, fileSize
            )
        )
